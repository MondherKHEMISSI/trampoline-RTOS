...
cSourceList.append(projfile.ProjectFile("lab3.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("lab3/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("lab3/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("lab3/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("lab3/tpl_primary_irq.S"))
cSourceList.append(projfile.ProjectFile("lab3/tpl_vectors.c"))
cSourceList.append(projfile.ProjectFile("lab3/tpl_external_interrupts.c"))
cSourceList.append(projfile.ProjectFile("lab3/tpl_app_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary lab3_exe.bin from lab3_exe")
  postCommand.mCommand.append(r"arm-none-eabi-objcopy")
  postCommand.mCommand += "-O binary".split()
  postCommand.mCommand.append("lab3_exe")
  postCommand.mCommand.append("lab3_exe.bin")
...
if make.errorCount() == 0:
  if askedGoal == "burn" :
    ...
    if makefile.find_executable("st-flash") != None:
      print("\033[1m\033[95mFlashing lab3_exe on cortex/armv7em/stm32f407/stm32f4discovery\033[0m")
