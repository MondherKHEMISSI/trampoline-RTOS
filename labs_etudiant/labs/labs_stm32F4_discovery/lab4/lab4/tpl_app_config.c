...
/* Task task_0 identifier */
#define task_0_id 1
CONST(TaskType, AUTOMATIC) task_0 = task_0_id;
...
/*-----------------------------------------------------------------------------
 * Task task_0 descriptor
 */
#define APP_Task_task_0_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task task_0 function prototype
 */

FUNC(void, OS_APPL_CODE) task_0_function(void);
 ...
 * Task task_0 stack
 */
#define APP_Task_task_0_START_SEC_STACK
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) task_0_stack_zone[300/sizeof(tpl_stack_word)];
#define APP_Task_task_0_STOP_SEC_STACK
#include "tpl_memmap.h"

#define task_0_STACK {task_0_stack_zone, 300}
...
#define OS_START_SEC_VAR_NOINIT_32BIT
#include "tpl_memmap.h"
VAR(arm_core_context, OS_VAR) task_0_int_context;

#define task_0_CONTEXT &task_0_int_context
...
/*
 * Static descriptor of task task_0
 */
CONST(tpl_proc_static, OS_CONST) task_0_task_stat_desc = {
  /* context                  */  task_0_CONTEXT,
  /* stack                    */  task_0_STACK,
  /* entry point (function)   */  task_0_function,
  /* internal ressource       */  NULL,
  /* task id                  */  task_0_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task task_0
 */
VAR(tpl_proc, OS_VAR) task_0_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
