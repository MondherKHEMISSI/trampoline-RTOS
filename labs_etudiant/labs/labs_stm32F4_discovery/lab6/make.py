...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file lab6.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=cortex/armv7em/stm32f407/stm32f4discovery --templates=../../../../goil/templates lab6.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("lab6/tpl_app_config.c")

sourceList.append("lab6/tpl_dispatch_table.c")
sourceList.append("lab6/tpl_invoque.S")
sourceList.append("lab6/tpl_primary_irq.S")
sourceList.append("lab6/tpl_vectors.c")
sourceList.append("lab6/tpl_external_interrupts.c")
sourceList.append("lab6/tpl_app_interrupts.c")
