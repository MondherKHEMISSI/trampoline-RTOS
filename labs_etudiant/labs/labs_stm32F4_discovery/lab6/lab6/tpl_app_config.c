...
/* Event ev_0 */
#define ev_0_mask 1
CONST(EventMaskType, AUTOMATIC) ev_0 = ev_0_mask;
...
/* Task Final identifier */
#define Final_id 2
CONST(TaskType, AUTOMATIC) Final = Final_id;
...
/* Alarm read_button_alarm identifier */
#define read_button_alarm_id 1
CONST(AlarmType, AUTOMATIC) read_button_alarm = read_button_alarm_id;
...
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) a_task_stack_zone[300/sizeof(tpl_stack_word)];
#define APP_Task_a_task_STOP_SEC_STACK
#include "tpl_memmap.h"

#define a_task_STACK {a_task_stack_zone, 300}
...
#define OS_START_SEC_VAR_NOINIT_32BIT
#include "tpl_memmap.h"
VAR(arm_core_context, OS_VAR) a_task_int_context;

#define a_task_CONTEXT &a_task_int_context
...
/*
 * Event structure of task a_task
 */
VAR(tpl_task_events, OS_VAR) a_task_task_evts = {
  /* event set  */ 0,
  /* event wait */ 0
};
...
/*-----------------------------------------------------------------------------
 * Task Final descriptor
 */
#define APP_Task_Final_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task Final function prototype
 */

FUNC(void, OS_APPL_CODE) Final_function(void);
 ...
 * Task Final stack
 */
#define APP_Task_Final_START_SEC_STACK
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) Final_stack_zone[300/sizeof(tpl_stack_word)];
#define APP_Task_Final_STOP_SEC_STACK
#include "tpl_memmap.h"

#define Final_STACK {Final_stack_zone, 300}
...
#define OS_START_SEC_VAR_NOINIT_32BIT
#include "tpl_memmap.h"
VAR(arm_core_context, OS_VAR) Final_int_context;

#define Final_CONTEXT &Final_int_context
...
/*
 * Static descriptor of task Final
 */
CONST(tpl_proc_static, OS_CONST) Final_task_stat_desc = {
  /* context                  */  Final_CONTEXT,
  /* stack                    */  Final_STACK,
  /* entry point (function)   */  Final_function,
  /* internal ressource       */  NULL,
  /* task id                  */  Final_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task Final
 */
VAR(tpl_proc, OS_VAR) Final_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) Init_stack_zone[300/sizeof(tpl_stack_word)];
#define APP_Task_Init_STOP_SEC_STACK
#include "tpl_memmap.h"

#define Init_STACK {Init_stack_zone, 300}
...
#define OS_START_SEC_VAR_NOINIT_32BIT
#include "tpl_memmap.h"
VAR(arm_core_context, OS_VAR) Init_int_context;
...
/*-----------------------------------------------------------------------------
 * Alarm read_button_alarm descriptor
 *
 * This alarm does the activation of task read_button
 */
...
CONST(tpl_task_activation_action, OS_CONST) read_button_alarm_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  read_button_id
...
CONST(tpl_alarm_static, OS_CONST) read_button_alarm_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , read_button_alarm_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&read_button_alarm_action
};
...
VAR(tpl_time_obj, OS_VAR) read_button_alarm_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&read_button_alarm_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  50,
    /* date                         */  50,
