...
cSourceList.append(projfile.ProjectFile("lab1.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary lab1_exe.bin from lab1_exe")
  ...
  postCommand.mCommand.append("lab1_exe.bin")
...
if make.errorCount() == 0:
  if askedGoal == "burn" :
    ...
    if makefile.find_executable("st-flash") != None:
      print("\033[1m\033[95mFlashing lab1_exe on cortex/armv7em/stm32f407/stm32f4discovery\033[0m")
